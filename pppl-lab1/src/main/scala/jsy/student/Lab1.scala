...
object Lab1 extends jsy.util.JsyApplication with jsy.lab1.Lab1Like {
  ...
  // this is where it gets tricky. If less than, traverse left.  If greater than, traverse right but if equal,
  // we call deleteMin on the right side to replace the node we are about to delete
